...
<body class="hold-transition login-page "style="background-color:#eabdbd;">
<div class="login-box">
...
<form action="pages/process_login.php" method="post">
      ...
      <div class="form-group">
          <button type="submit" class="btn btn-primary" style="    background-color: #dd4b39;
    border-color: #d73925;">Login</button>
      </div>
    </form>
